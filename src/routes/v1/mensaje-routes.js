...
import { probarChat, getMensajesPrueba } from "../../controllers/mensaje-controller.js";
...
routes.post("/probar-chat", validateRequest(validateCreateMensaje, reqValidate.BODY), probarChat);
routes.get("/probar-chat", getMensajesPrueba);
